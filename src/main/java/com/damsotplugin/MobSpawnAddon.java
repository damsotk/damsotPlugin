...
//         int intervalTicks = (random.nextInt(3) + 4) * 60 * 20; // Задержка от 4 до 6 минут
...
//                 int mobCount = random.nextInt(6) + 1; // От 1 до 6 мобов
...
//                             MythicBukkit.inst().getAPIHelper().getMythicMobInstance(spawnedEntity);
//                             Bukkit.getLogger().info("Заспавнил моба: " + mobName + " для: " + player.getName() + " на " + spawnLocation);
//                         }
